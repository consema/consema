...
>
> **状态注记（2026-08-15 追加）**：本文 §0/§26/§28 以将来时表述的 `0.1.0`
> 准确范围、实施顺序与发布门槛均已落地——`0.1.0` 已于 2026-08-04 发布
> （git tag v0.1.0 = 4d07c24，路线图 §13「0.1.0 JSON/JSONC 与核心语义证明
> 已完成」）；相关段落保留为历史规划措辞，本文继续定义现有语义基线与永久不变量。
