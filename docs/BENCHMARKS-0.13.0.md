...
roadmap §15.5 linearity gate — "经验证的线性或明确复杂度" — is
...
Effective 0.13.0; implements roadmap §20.3 and §15.5 and the M5
...
- **Finding — superlinear scenario paths (reported 2026-08-07, FIXED and
  ...
  claim is now verified**: S1/S3/S4 and the pilot F-2 conversion
